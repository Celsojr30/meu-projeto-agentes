...
2. Redator Técnico e Especialista em Engajamento: Recebe o relatório compilado, aplica técnicas de copywriting e formata o conteúdo sob medida para a rede social.
...
* Google Gemini API: Modelos de linguagem para inferência de alta velocidade.
...
Rode no terminal para criar e ativar o ambiente no Windows:
python -m venv venv
...
Com o ambiente ativo e as chaves configuradas, inicialize o servidor do Streamlit:
...
As credenciais e tokens privados de acesso às APIs nunca devem ser enviados para repositórios públicos. O arquivo .gitignore deste projeto está pré-configurado para ignorar o arquivo .env, a pasta venv/ e caches do sistema.